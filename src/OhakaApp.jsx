...
const SK = 'ohaka_v3'
const load = () => { try { return JSON.parse(localStorage.getItem(SK)) || { graves: [], memories: [], events: [], family: [], mosimo: {}, notes: '' } } catch { return { graves: [], memories: [], events: [], family: [], mosimo: {}, notes: '' } } }
