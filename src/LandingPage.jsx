...
export default function LandingPage({ onEnterApp }) {
  ...
  const features = [
    ...
    { icon:'📓', title:'もしもノート', desc:'葬儀の希望・財産・保険・緊急連絡先・デジタル資産・家族へのメッセージ。万が一に備える6つのセクション。', tag:'最重要機能' },
    ...
    { icon:'◇', title:'AI相談（24時間対応）', desc:'葬儀の費用、戒名の相場、墓じまいの手順——知りたい時に専門家レベルの回答がすぐ得られます。', tag:'いつでも相談' },
      ...
      <section className="lp-mosimo">
        <div className="lp-mosimo-hero fade-up">
          ...
          <div className="lp-mosimo-items">
            {['葬儀の希望','財産・保険','緊急連絡先','デジタル資産','遺言メモ','ペット・家の引き継ぎ'].map(t => (
